...
const Notifications = () => {
  return (
    <div id='about-us' className="xl:mx-auto xl:max-w-[1440px] lg:flex lg:items-center justify-between flex-row-reverse">
      <img src={notification} alt="" className="lg:rounded-l-[100px] lg:w-[43%] mx-auto md:w-auto w-full pb-10 lg:pb-0 lg:mr-0 h-[600px] sm:h-[800px] lg:h-auto object-cover" />
