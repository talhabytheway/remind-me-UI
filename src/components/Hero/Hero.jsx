  ...
  return (
    <div className="relative">
        ...
        >
          ...
          <ul
            className={`block absolute px-[1.5rem] md:px-[3rem] lg:flex align-right lg:items-center !z-[100] transition-all ease-in duration-500 w-[100%] left-0 top-0 lg:w-auto lg:z-auto lg:static  lg:bg-none  lg:space-x-10 space-y-2.5 lg:space-y-0 my-auto opacity-100 p-3 lg:p-0 lg:mb-auto hover:[&>*]:text-blue hover:[&>*]:duration-500 hover:[&>*]:opacity-100 hover:[&>*]:cursor-pointer ${
              open
                ? " top-[80px] opacity-100 bg-dark lg:bg-transparent bg-white"
                : " top-[-300px] opacity-0"
            } `}
          >
            <li>
      ...
      <div className="w-full xl:max-w-[1440px] px-[1.5rem] md:px-[3rem] lg:px-[6rem] mx-auto">
        <div className="lg:w-[50%] flex flex-col gap-6 lg:py-5 xl:py-16">
          ...
          <img
            src={heroImg}
            alt=""
            className="mx-auto lg:absolute lg:top-0 lg:right-0 lg:w-[40%] md:max-w-[500px] w-[90%] lg:rounded-bl-[70px]"
          />
        </div>
      </div>
    </div>
