  ...
  return (
    <div className="xl:mx-auto xl:min-w-[1280px] px-[1.5rem] md:px-[3rem] lg:px-[6rem] gap-6 lg:gap-0 flex flex-col lg:flex-row lg:justify-between pb-10">
      <div className="lg:w-[35%] md:flex mx-auto lg:mx-0 md:gap-10 lg:gap-5 items-center flex-wrap">
        <img src={logo} alt="" className="h-20 md:h-15 lg:h-20 mx-auto lg:m-0 "/>
        <p className="max-w-[400px] md:max-w-[300px] lg:max-w-[400px] text-center md:text-left text-grey">
      ...
      <div className="">
        <h4 className="sm:text-[20px] lg:text-[24px] font-semibold pb-3 lg:pb-10 lg:pt-6">Sitemaps</h4>
        <ul className="text-blue list-disc list-inside">
          <li><Link
              spy={true}
              smooth={true}
              offset={-70}
      ...
      <div className="">
        <h4 className="sm:text-[20px] lg:text-[24px] font-semibold pb-3 lg:pb-10 lg:pt-6">Advantages</h4>
        <ul className="text-blue [&>li>span]:text-grey list-disc list-inside">
      ...
      <div className="mx-auto lg:mx-0">
        <h4 className="sm:text-[20px] lg:text-[24px] font-semibold pb-3 lg:pb-10 lg:pt-6 text-center lg:text-left">Follow Us</h4>
